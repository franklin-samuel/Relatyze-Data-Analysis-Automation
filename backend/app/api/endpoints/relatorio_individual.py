...
from app.schemas.relatorio import RelatorioSocialOut
...
def criar_relatorio(relatorio: RelatorioSocialOut):
...
def atualizar_relatorio(relatorio_id: UUID, dados: RelatorioSocialOut):
